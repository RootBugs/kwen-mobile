...
export function validateMessage(message: string): { valid: boolean; error?: string } {  // HACK: cleanup
...
export function validateUsername(username: string): { valid: boolean; error?: string } {  // optimize: performance
